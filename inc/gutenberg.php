...
/**
 * Enqueue the WP Email Capture Premium Gutenberg editor CSS.
 * 
 * @return void
 */
function ebay_feeds_for_wordpress_enqueue_block_editor_css() {
	wp_enqueue_style(
		'ebay-feeds-for-wordpress-gutenberg-css-styles',
		EBAYFEEDSFORWORDPRESS_PLUGIN_URL . '/inc/css/wp-email-capture-gutenberg-styles.css',
		array( 'wp-edit-blocks' ),
		filemtime( EBAYFEEDSFORWORDPRESS_PLUGIN_PATH . 'css/wp-email-capture-gutenberg-styles.css' )
	);
}
